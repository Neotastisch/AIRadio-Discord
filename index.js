...
async function get(item, nextsong, url){
    ...
    let msg = 'Stell dir vor, du waerst ein AI Radiosender (auf der Sprache '+language+'). Schreibe es so, als wuerde diese Nachricht nach einem Song sein. Du sollst jetzt etwas ueber '+item.title+' erzaehlen. Schreibe es so, als koennte man es direkt ausstrahlen, erfinde nichts. Daten: '+item.description+'. Dann sage, dass als naechtes das lied '+nextsong+' you abgespielt wird.'
